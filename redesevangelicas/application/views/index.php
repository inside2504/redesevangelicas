				...
				<section>
					<aside class="row">
						<aside class="col-lg-4">
							<div class="cuadro">
								<aside>
									<h4>Enlace cristiano Banderilla</h4>
								</aside>
								<img class="img-responsive" src="<?=base_url('')."assets/img/1enlace.jpg"?>">
							</div>
						</aside>
						<aside class="col-lg-4">
							<div class="cuadro">
								<aside>
									<h4>Semillas de fuego</h4>
								</aside>
								<img class="img-responsive" src="<?=base_url('')."assets/img/2semillas.jpg"?>">
							</div>
						</aside>
						<aside class="col-lg-4">
							<div class="cuadro">
								...
								<img class="img-responsive" src="<?=base_url('')."assets/img/3casa.jpg"?>">
							</div>
						</aside>
					</aside>
					<aside class="row">
						<aside class="col-lg-4">
							<div class="cuadro">
								<aside>
									<h4>Vida en abundancia de M&eacute;xico A.C.</h4>
								</aside>
								<img class="img-responsive" src="<?=base_url('')."assets/img/4vida.jpg"?>">
							</div>
						</aside>
						<aside class="col-lg-4">
							<div class="cuadro">
								...
								<img class="img-responsive" src="<?=base_url('')."assets/img/5nueva.jpg"?>">
							</div>
						</aside>
						<aside class="col-lg-4">
							<div class="cuadro">
								...
								<img class="img-responsive" src="<?=base_url('')."assets/img/6lids.jpg"?>">
							</div>
						</aside>
					</aside>
					<aside class="row">
						<aside class="col-lg-4">
							<div class="cuadro">
								<aside>
									<h4>Iglesia nacional presbiteriana</h4>
								</aside>
								<img class="img-responsive" src="<?=base_url('')."assets/img/7inpm.jpg"?>">
							</div>
						</aside>
					</aside>
				</section>
		...
		<div class="prefoot">
			<aside class="row">
				<aside class="col-lg-4">
					<div class="tit">
						<h4>Contenido</h4>
						<a href="">Tenemos materiales para ti</a>
					</div>
				</aside>
				<aside class="col-lg-4">
					<div class="tit">
						<h4>Cont&aacute;ctanos</h4>
						<a href="">Da clic para ponerte en contacto con nosotros</a>
					</div>
				</aside>
				<aside class="col-lg-4">
					<div class="tit">
