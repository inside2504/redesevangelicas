<div class="main">
	...
	<div class="content">
		<form class="pure-form pure-form-aligned" enctype="multipart/form-data" method="POST" action="<?php echo base_url('index.php/tianguis/editimg');?>">
			...
			<fieldset>
				<legend>Datos de la foto</legend>
					...
					<p class="pull-right">Los formatos admitidos son: .jpg, .jpeg y .png.<br>Las medidas de la imagen del producto deben ser menores de 1000x1000px.</p>
