		...
		<div class="container">
	        <div class="advice">
	        	<div class="center">
		        	...
		        	<h2>Los cap&iacute;tulos se encuentran en orden del primero al &uacute;ltimo.</h2>
		        	<section class="container">
				        <div class="pull-right">
				            <form action="<?php echo base_url('index.php/kidsview/buscar');?>" method="GET" >
				                <fieldset>
				                    <h4>Filtrar por serie
			    ...
			    <div class="serie">
		            <div class="row">
		            	<?php  if ($this->my_model->getAlltitulo() !=0):?>
				                 ...
				                 <div class="col-md-4 col-sm-6">
				                    <div class="blog-item">
				                        <div class="row">
				                            ...
				                            <div class="advice">
					                            <p class="lead">Fecha de creaci&oacute;n: <?php echo $row->FechaCreacion ?></p>
					                            <p class="lead"><strong> Serie <?php echo $row->NombreSerie ?></strong></p>
