			...
			<fieldset>
				<legend>Datos de la iglesia</legend>
					<div class="pure-control-group">
	            		...
	            		<input name="iglesia" class="pure-input-1-2" type="text" value="<?php echo ""; ?>">
					</div>
					<div class="pure-control-group">
					...
					<div class="pure-control-group">
	            		...
	            		<textarea name="descripcion" class="pure-input-1-2" type="text" placeholder="Descripción"></textarea>
					</div>
					<div class="pure-control-group">
