<div id="main">
        ...
        <div class="content">
            <section class="acciones">
                ...
                <p class="pure-u-1-3"><a href="<?php echo site_url('iglesia/editiglesia')?>">Editar una iglesia</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/igleadmin/#')?>">Eliminar una iglesia</a></p>
            </section>
            <section>
                <h2>Instrucciones</h2>
                ...
                <p>Si desea <strong><em>eliminar una iglesia</em></strong> registrada, entonces haga clic en <strong><em>"Eliminar una iglesia"</em></strong> para <strong><em>eliminarla del sistema</em></strong>.</p>
            </section>
            <section>
                <div>
                            ...
                            <?php
                                foreach ($this->my_model->get() as $row) {
                                    echo "<tr>
                                            ...
                                            <td>$row->edoIgle</td>
                                            <td>$row->telIgle</td>
                                            <td><a href='".site_url('iglesia/editiglesia/'.$row->idIgle)."'>Editar</a><td>
                                        </tr>
                                    ";
                                }
                            ?>
