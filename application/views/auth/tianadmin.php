<div id="main">
        ...
        <div class="content">
            <section class="acciones">
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/regproducto')?>">Registrar un producto</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/editproducto#')?>">Editar un producto</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/tianadmin/#')?>">Eliminar un producto</a></p>
            </section>
            <section>
                <h2>Instrucciones</h2>
