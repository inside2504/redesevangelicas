<div id="main">
        ...
        <div class="content">
            <section class="acciones">
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/regmaterial')?>">Registrar un material</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/editmaterial')?>">Editar un material</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('auth/mateadmin/#')?>">Eliminar un material</a></p>
            </section>
            <section>
                <h2>Instrucciones</h2>
