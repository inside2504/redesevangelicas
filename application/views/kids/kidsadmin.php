        ...
        <section>
            <div>
                <table class="pure-table pure-table-bordered" cellpadding=0 cellspacing=10>
                    ...
                    <tbody>
                        <?php
                            foreach ($this->my_model->gettitulo() as $row) {
                                echo "<tr>
                                        <td>$row->NombreSerie</td>
                                        <td><a href='".site_url('kids/editartitulo/'.$row->idTituloSerie)."'>Editar</a></td> 
                                        <td><a href='".site_url('kids/eliminartitulo/'.$row->idTituloSerie)."'>Eliminar</a></td>
                                    </tr>
                                ";
                            }
                        ?>
        ...
        <section>
            <div>
                <table class="pure-table pure-table-bordered" cellpadding=0 cellspacing=10>
                    ...
                    <tbody>
                        <?php
                            foreach ($this->my_model->getAlltitulo() as $row) {
                                echo "<tr>
