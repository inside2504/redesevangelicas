<div class="main">
	...
	<div class="content">
		<form class="pure-form pure-form-aligned" enctype="multipart/form-data" method="POST" action="<?php echo base_url('index.php/empresa/editimg');?>">
			<input name="idi" class="pure-input-1-2" type="text" style="visibility:hidden" value="<?php echo $cols->idFotoResp ?>">
			<fieldset>
				<legend>Datos de la foto</legend>
					...
					<div class="pure-control-group">
						<label for="userfile">Foto del responsable:</label>
