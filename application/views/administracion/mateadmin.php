<div id="main">
        ...
        <div class="content">
            <section class="acciones">
                <p class="pure-u-1-3"><a href="<?php echo site_url('administracion/mateadmin/#')?>">Registrar un material</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('administracion/mateadmin/#')?>">Editar un material</a></p>
