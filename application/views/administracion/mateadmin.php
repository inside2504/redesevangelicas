<div id="main">
        ...
        <div class="content">
            <section class="acciones">
                <p class="pure-u-1-3"><a href="<?php echo site_url('administracion/regmaterial')?>">Registrar un material</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('administracion/editmaterial')?>">Editar un material</a></p>
                <p class="pure-u-1-3"><a href="<?php echo site_url('administracion/mateadmin/#')?>">Eliminar un material</a></p>
            </section>
