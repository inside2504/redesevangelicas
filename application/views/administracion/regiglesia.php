<div class="main">
	...
	<div class="content">
		<form class="pure-form pure-form-aligned" method="POST" action="<?php base_url('iglesia/guardar');?>">
			<fieldset>
				<legend>Datos de la iglesia</legend>
					<div class="pure-control-group">
						<label for="iglesia">Nombre de la iglesia:</label>
	            		<input id="iglesia" class="pure-input-1-2" type="text" placeholder="Nombre">
					</div>
					<div class="pure-control-group">
					...
					<div class="pure-control-group">
	            		...
	            		<textarea id="descripcion" class="pure-input-1-2" type="text" placeholder="Descripcion"></textarea>
					</div>
					<div class="pure-control-group">
				...
				<legend>Direcci&oacute;n</legend>
					...
					<div class="pure-control-group">
	            		...
	            		<input id="codigo" class="pure-input-1-2" type="text" placeholder="Código postal">
					</div>
					<div class="pure-control-group">
						<label for="ciudad">Ciudad:</label>
	            		<input id="ciudad" class="pure-input-1-2" type="text" placeholder="Ciudad">
					</div>
					<div class="pure-control-group">
						<label for="edo">Estado:</label>
	            		<input id="edo" class="pure-input-1-2" type="text" placeholder="Estado">
					</div>
				<legend>Contacto</legend>
					...
					<div class="pure-control-group">
			       	...
			       	<div class="pure-control-group">
	            		...
	            		<input id="fb" class="pure-input-1-2" type="text" placeholder="Dirección de Facebook">
					</div>
					<div class="pure-control-group">
