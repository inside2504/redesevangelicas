...
<div id="layout">
    ...
    <div id="menu">
        <div class="pure-menu">
            <a class="pure-menu-heading" href="#">Bienvenido</a>
            ...
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item">
                	<a href="#" class="pure-menu-link">Empresas</a>
                </li>
                <li class="pure-menu-item">
                	<a href="#" class="pure-menu-link">Materiales</a>
                </li>
                <li class="pure-menu-item">
                	<a href="#" class="pure-menu-link">Eventos</a>
                </li>
                <li class="pure-menu-item">
