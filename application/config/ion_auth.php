...
*/
$config['tables']['Usuario']           = 'Usuario';
$config['tables']['Grupos']            = 'Grupos';
$config['tables']['Grupos_Usuarios']   = 'Grupos_Usuarios';
$config['tables']['Intentos_Login']    = 'Intentos_Login';
 ...
 */
$config['join']['Usuario']  = 'AidiUsuario';
$config['join']['Grupos'] = 'AidiGrupo';
...
$config['default_group']              = 'Poster';          	 // Default group, use name
$config['admin_group']                = 'Admin';             // Default administrators group, use name
$config['identity']                   = 'CorreUser';         // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
 ...
 */
$config['remember_cookie_name'] = 'Code_Recordatorio';
